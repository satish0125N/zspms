...
// Create a new plugin file: wp-content/plugins/custom-api-endpoints/custom-api-endpoints.php

/*
Plugin Name: Custom API Endpoints
Description: Custom endpoints for user registration and login
Version: 1.0
Author: Your Name
*/
...
add_action('rest_api_init', function () {
	// Register custom REST route for user registration
	...
	// Register custom REST route for user login
...
// function custom_user_login(WP_REST_Request $request)
// {
// 	$username = sanitize_text_field($request->get_param('username'));
// 	$password = $request->get_param('password');

// 	if (empty($username) || empty($password)) {
// 		return new WP_Error('missing_data', 'Please provide username and password.', array('status' => 400));
// 	}
...
// 	// You can generate a custom token or handle authentication however you'd like here
